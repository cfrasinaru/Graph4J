...
// */
//class GraphImpl1<V, E> implements Graph<V, E> {
//    //graph
...
//
//    protected GraphImpl1() {
//    }
//
//    @Deprecated
//    private GraphImpl1(int numVertices, int maxVertices, int avgDegree,
...
//     */
//    protected GraphImpl1(int[] vertices, int maxVertices, int avgDegree,
//            boolean directed, boolean allowingMultipleEdges, boolean allowingSelfLoops) {
...
//    }
//
//    protected GraphImpl1 newInstance() {
//        return new GraphImpl1();
//    }
//
//    protected GraphImpl1 newInstance(int[] vertices, int maxVertices, int avgDegree,
//            boolean directed, boolean allowingMultipleEdges, boolean allowingSelfLoops) {
//        return new GraphImpl1(vertices, maxVertices, avgDegree, directed, allowingMultipleEdges, allowingSelfLoops);
//    }
//
//    /*
//    @Deprecated
//    public void enableAdjListMatrix() {
//        createAdjListMatrix();
//    }*/
//    @Override
...
//        if (edgeLabels) {
//            /*
//            if (this.labelEdgeIndexMap != null) {
//                //copy.labelEdgeIndexMap = new Map2Long<>(labelEdgeIndexMap);
//            } else */
...
//
//    @Override
//    public void addWeightedLabeledEdge(int v, int u, double weight, E label) {
//        addEdge(v, u, weight, label);
//    }
//
//    //the main addEdge method
//    protected int addEdge(int v, int u, Double weight, E label) {
//        if (safeMode) {
...
//        }
//        GraphImpl1<V, E> complement = (GraphImpl1<V, E>) copy(true, true, false, false, false);
...
//            return false;
//        }
//        final GraphImpl1<?, ?> other = (GraphImpl1<?, ?>) obj;
