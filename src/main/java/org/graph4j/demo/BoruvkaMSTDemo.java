...
class BoruvkaMSTDemo extends PerformanceDemo {
    ...
    protected void testGraph4J() {
        var alg = new BoruvkaMinimumSpanningTreeDefault(graph);
    ...
    protected void testJGraphT() {
        var alg = new org.jgrapht.alg.spanning.BoruvkaMinimumSpanningTree(jgrapht);
        System.out.println(alg.getSpanningTree().getWeight());
    }

    @Override
    protected void testAlgs4() {
        var alg = new BoruvkaMST(algs4Ewg);
    ...
    protected void testOther() {
        var alg = new BoruvkaMinimumSpanningTreeParallel(graph);
        System.out.println(alg.getWeight());
        //alg.getEdges();
    }
