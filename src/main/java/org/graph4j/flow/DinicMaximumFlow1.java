...
// */
//public class DinicMaximumFlow1 extends MaximumFlowBase {
//
//    private int[] levels;
//    private int[] succPos;
//    private int[] predPos;
...
//
//    public DinicMaximumFlow1(Network graph) {
//        super(graph);
//    }
//
//    public DinicMaximumFlow1(Network graph, FlowData flow) {
//        super(graph, flow);
//    }
//
//    @Override
...
//        //if (debug) System.out.println("---------> CREATE LEVELS");
//        int[] prevLevels = IntArrays.copyOf(levels);
...
//            }
//        }
//        //for (int i = 0; i < numVertices; i++) System.out.println("level " + graph.vertexAt(i) + " = " + levels[i]);
//        //if (debug) System.out.println(Arrays.toString(levels));
//        assert !Arrays.equals(prevLevels, levels);
//
...
//        //if (debug) System.out.println("---------> CREATE BLOCKING FLOW");
//
...
//            int vi = graph.indexOf(v);
//            //forward
//            //if (debug) System.out.println("going forward from " + v + ", currentSuccPos: " + succPos[vi]);
//
...
//                //if (debug) System.out.println("\t to " + u + ", edge residual=" + edgeResidual);                
//                if (edgeResidual == 0) {
//                    //if (debug) System.out.println("\tNot admissible.");
//                    continue;
//                }
//                visited[ui] = true;
//                parent[ui] = vi;
...
//            }
//
//            //if (debug) System.out.println("going backward from " + v + ", currentPredPos=" + predPos[vi]);
//            //backward
...
//            stack.pop();
//        }
//        // if (debug) System.out.println("Flow increased: " + flowIncreased + " times");
//        return flowIncreased > 0;
//    }
//
//    private void augmentFlow() {
//        double r = residual[sinkIndex];
//        //if (debug) System.out.println("Found augmenting path, residual capacity=" + r);
//        int bi = sinkIndex;
//        do {
//            residual[bi] -= r;
//            if (residual[bi] == 0) {
...
//        //System.out.println("\tAugmenting path length = " + k);
//    }
//}
