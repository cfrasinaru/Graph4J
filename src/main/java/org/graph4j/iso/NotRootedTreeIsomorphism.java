...
public class NotRootedTreeIsomorphism implements Isomorphism {
    ...
    /**
     * Constructor for the not rooted tree isomorphism algorithm.
     * Validates the trees.
     *
     ...
     *     Does the following:
     *     <ul>
     *         <li>Gets the centers for each tree.</li>
     *         <li>Checks if the number of centers is the same for both trees.</li>
     *         <li>If yes, it will try all combinations of choosing a root for the first tree with a root from second tree.
     *         A root is a vertex from centers list.</li>
     *         <li>If any of this combination is successful, it means that the trees are isomorphic.</li>
     *     </ul>
     * </p>
