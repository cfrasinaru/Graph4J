 ...
 */
abstract class EdgeCollection3 {
     ...
     */
    public EdgeCollection3(Graph graph) {
     ...
     */
    public EdgeCollection3(Graph graph, int initialCapacity) {
        this.graph = graph;
     ...
     */
    public EdgeCollection3(Graph graph, int[][] edges) {
        this.graph = graph;
        this.edges = edges;
     ...
     */
    protected boolean add(int v, int u) {
        if (numEdges == edges.length) {
            grow();
        }
        edges[numEdges++][0] = v;
