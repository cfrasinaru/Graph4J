...
// */
//@Deprecated
//class EdmondsKarpMaximumFlow1 extends DirectedGraphAlgorithm
...
//    //
//    protected VertexSet[] succ, pred;
//    protected double[] succValue, predValue;
//
//    /**
//     *
//     * @param graph
...
//     * @param sink
//     */
//    public EdmondsKarpMaximumFlow1(Digraph graph, int source, int sink) {
//        super(graph);
//        this.source = source;
//        this.sink = sink;
//    }
...
//        return flowMap.getOrDefault(new IntPair(vi, ui), 0.0);
//    }
//
//    @Override
...
//            int u = it.next();
//            int ui = graph.indexOf(u);
//            value += flowMap.getOrDefault(new IntPair(si, ui), 0.0);
//        }
//        return value;
//    }
//
...
//                continue;
//            }
//            double flow = flowMap.getOrDefault(new IntPair(vi, ui), 0.0);
...
//                continue;
//            }
//            double flow = flowMap.getOrDefault(new IntPair(ui, vi), 0.0);
//            if (flow > 0) {
...
//        flowMap = new HashMap<>(graph.numEdges());
//
//        int si = graph.indexOf(source);
