...
public class VF2ExactGraphIsomorphismTest {
    ...
    @Test
    public void testLabeledMultigraph() {
        Multigraph g1 = GraphBuilder.vertices(0, 1, 2, 3, 4, 5).buildMultigraph();
        Multigraph g2 = GraphBuilder.vertices(0, 1, 2, 3, 4, 5).buildMultigraph();
...
//        System.out.println("g2 edge label of (0, 1): " + g2.getEdgeLabel(5, 3));
//        System.out.println("g1 edges: " + Arrays.toString(g1.edges()));
//        System.out.println("g1 neighbors of 0: " + Arrays.toString(g1.neighbors(0)));
//        for (var e : g1.outgoingEdgesFrom(0)) {
//            if (e == null)
//                continue;
//
//            int u = e.source();
...
//        }
    ...
    @Test
    public void testLabeledPseudoGraph() {
        Pseudograph g1 = GraphBuilder.vertices(0, 1, 2, 3, 4, 5).buildPseudograph();
        Pseudograph g2 = GraphBuilder.vertices(0, 1, 2, 3, 4, 5).buildPseudograph();
